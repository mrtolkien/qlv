  ...
  body: (p) => {
    ...
    const maybe_vias = (p) => {
      ...
      if (p.via_to) {
        ...
        (pad 3 thru_hole circle (at -2.6 1.1 ${
          p.rot
        }) (size 0.6 0.6) (drill 0.3) (layers *.Cu) (zone_connect 2) ${
          p.to.str
        })
        ...
        ${
          p.front
            ? `(pad 4 smd rect (at -2.25 0.75 ${
                p.rot - 45
              }) (size 0.25 1) (layers F.Cu)  ${p.to.str})`
            : ""
        }
        ${
          p.back
            ? `(pad 5 smd rect (at -2.25 0.75 ${
                p.rot - 45
              }) (size 0.25 1) (layers B.Cu)  ${p.to.str})`
            : ""
        }
        `;
      }
      ...
      if (p.via_from) {
        vias += `
        ${"" /* Vias next to smd pads */}
        (pad 6 thru_hole circle (at 2.6 1.1 ${
          p.rot
        }) (size 0.6 0.6) (drill 0.3) (layers *.Cu) (zone_connect 2) ${
          p.from.str
        })
        ...
        ${
          p.front
            ? `(pad 7 smd rect (at 2.25 0.75 ${
                p.rot + 45
              }) (size 0.25 1) (layers F.Cu)  ${p.from.str})`
            : ""
        }
        ${
          p.back
            ? `(pad 8 smd rect (at 2.25 0.75 ${
                p.rot + 45
              }) (size 0.25 1) (layers B.Cu)  ${p.from.str})`
            : ""
        }
        `;
      }
    ...
    const maybe_through_holes = (p) => {
      ...
      return `
        ${"" /* THT terminals */}
        (pad 1 thru_hole circle (at -3.81 0 ${
          p.rot
        }) (size 1.905 1.905) (drill 0.9906) (layers *.Cu *.Mask) ${p.to.str})
